          ...
          <div className="row">
            <div className="col-lg-10 m-auto">
              <div className="blog-deatils-content heading2">
                ...
                <div className="space16" />
                <p>
                  We expect participants who are asked to stop any harassing behavior
                  ...
                  such as a warning or expulsion from the conference.
                </p>
                <div className="space16" />
                <p>
                  If you are being harassed, observe that someone else is being
                  harassed or have comments about harassment, please contact the
                  conference organizing team immediately or ask the technical staff
                  for us. Event staff will help participants contact venue organizers,
                ...
                <p>
                  ...
                  expectations for all those participating in DevBcn both online
                  and offline, as well as the consequences of unacceptable behavior.
                </p>
                ...
                <div className="space16" />
                <p>
                  Please remember that mistakes happen, you are not a bad person,
                  just re-evaluate your behavior and do better next time.
                </p>
                <div className="space48" />
