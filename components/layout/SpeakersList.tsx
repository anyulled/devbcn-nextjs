...
import SpeakersFilterBar from "./SpeakersFilterBar";
...
function SpeakersListContent({ speakers, year }: Readonly<SpeakersListProps>) {
    ...
    <div className="container mb-5 pb-5">
      <div className="row mb-5">
        <div className="col-12">
          <SpeakersFilterBar placeholder="Search by name, tagline, or bio..." />
        </div>
      </div>
...
export default function SpeakersList({ speakers, year }: Readonly<SpeakersListProps>) {
  return (
