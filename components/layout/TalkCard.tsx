...
import { getLevelFromTalk, getLevelStars, getTagsFromTalk } from "@/hooks/useTalks";
      ...
      <div className="talk-card-content">
        ...
        <div className="talk-speakers">
          {talk.speakers.map((speaker, index) => (
            <span key={speaker.id}>
              <Link href={`/${year}/speakers/${speaker.id}`} className="speaker-link">
                {speaker.name}
              </Link>
        ...
        <div className="talk-actions">
          <a href={voteUrl} target="_blank" rel="noopener noreferrer" className="vote-link vl-btn1">
