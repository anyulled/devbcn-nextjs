...
export default function Header9({ scroll, isMobileMenu, handleMobileMenu, isSearch, handleSearch }: any) {
	...
	const yearFromPath = segments[0] && /^\d{4}$/.test(segments[0])
		? segments[0]
									...
									<ul>
										<li>
											...
											<ul className="dropdown-padding">
												<li><Link href="/2025">2025 Edition</Link></li>
												<li><Link href="/2024">2024 Edition</Link></li>
												<li><Link href="/2023">2023 Edition</Link></li>
											</ul>
										</li>
										...
										<li>
											<Link href="/#">News <i className="fa-solid fa-angle-down" /></Link>
											<ul className="dropdown-padding">
												<li><Link href={withYear('/cfp')}>CFP</Link></li>
												<li><Link href={withYear('/diversity')}>Diversity</Link></li>
												<li><Link href={withYear('/job-offers')}>Job Offers</Link></li>
