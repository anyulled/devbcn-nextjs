...
export default function Header3({ scroll, isMobileMenu, handleMobileMenu, isSearch, handleSearch }: HeaderProps) {
  return (
    <header>
                          ...
                          <div className="col-lg-12">
                            <div className="all-images-menu">
                              ...
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index2">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                              ...
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index3">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                              ...
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index4">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                              ...
                              <div className="homemenu-thumb" style={{ margin: 0 }}>
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index5">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                            ...
                            <div className="all-images-menu">
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index6">
                                    View DEMO{" "}
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                              ...
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index7">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                              ...
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index8">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                              ...
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index9">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
                              ...
                              <div className="homemenu-thumb" style={{ margin: 0 }}>
                                ...
                                <div className="homemenu-btn">
                                  <Link className="vl-btn3" href="/index10">
                                    View DEMO
                                  </Link>
                                </div>
                                <div className="homemenu-text">
