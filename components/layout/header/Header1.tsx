						...
						<div className="col-lg-12">
							<div className="header-elements">
								<div className="site-logo">
									<Link href="/"><Image src="/assets/img/logo/logo1.png" alt="Logo" width={150} height={40} style={{ width: 'auto', height: 'auto' }} /></Link>
								</div>
													...
													<div className="col-lg-12">
														<div className="all-images-menu">
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img1.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
															...
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img2.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
															...
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img3.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
															...
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img4.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
															...
															<div className="homemenu-thumb" style={{ margin: 0 }}>
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img5.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
														...
														<div className="all-images-menu">
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img6.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
															...
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img7.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
															...
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img8.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
															...
															<div className="homemenu-thumb">
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img9.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
															...
															<div className="homemenu-thumb" style={{ margin: 0 }}>
																<div className="img1">
																	<Image src="/assets/img/all-images/demo/demo-img10.png" alt="" width={300} height={300} style={{ width: '100%', height: 'auto' }} />
																</div>
																<div className="homemenu-btn">
								...
								<div className="btn-area">
									<div className="search-icon header__search header-search-btn" onClick={handleSearch}>
										<a><Image src="/assets/img/icons/search1.svg" alt="" width={20} height={20} /></a>
									</div>
									<ul>
										<li>
								...
								<div className={`header-search-form-wrapper ${isSearch ? 'open' : ''}`}>
									...
									<div className="header-search-container">
										<form role="search" className="search-form">
											...
											<button type="submit" className="search-submit"><Image src="/assets/img/icons/search1.svg" alt="" width={20} height={20} /></button>
										</form>
									</div>
								</div>
