          ...
          <div className="row">
            <div className="col-lg-12">
              <Slider {...settings} className="testimonial-reviews-area">
                ...
                <div className="testimonial-boxarea">
                  <p>
                    “Attending this summit was one of the best decisions I made this year. The speakers provided real-world insights that I could immediately
                ...
                <div className="testimonial-boxarea">
                  <p>
                    “The summit offered a great mix of theory and practice. I appreciated how the workshops dug deep into practical strategies while the keynote
                    sessions inspired me to think bigger.”
                  </p>
              ...
              <Slider {...settings2} className="testimonial-reviews-area2">
                <div className="testimonial-boxarea">
                  <p>
                    “The networking opportunities were unparalleled. Beyond the valuable sessions, I found myself in meaningful conversations with other
                    attendees who shared similar challenges.”
                  </p>
                  <Link href="/#">Sarah M.</Link>
                </div>
                <div className="testimonial-boxarea">
                  <p>
                    “From the well-organized sessions to the exceptional lineup of speakers, everything about this summit was top-notch. It was a fantastic
                ...
                <div className="testimonial-boxarea">
                  <p>
                    “I’ve attended many industry events, but this summit was a standout. The variety of sessions kept things engaging, and I appreciated how the
                    content was tailored for different experience levels.”
                  </p>
                  <Link href="/#">Sarah M.</Link>
                </div>
                <div className="testimonial-boxarea">
