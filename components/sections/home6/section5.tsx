            ...
            >
              <div className="skils-widget-boxarea">
                ...
                <div className="content-area">
                  ...
                  <p>
                    Join industry leaders and like-minded peers, and expand your
                    network with a dynamic community ready to support your
            ...
            >
              <div className="skils-widget-boxarea">
                ...
                <div className="content-area">
                  ...
                  <div className="space16" />
                  <p>
                    Every obstacle has a solution, and we bring together experts
                    who’ve been through it all. Get practical advice, tips, and
                    guidance to challenges faster.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="skils-widget-boxarea">
                ...
                <div className="content-area">
                  ...
                  <div className="space16" />
                  <p>
                    Immerse yourself in tailored sessions that address your
                    biggest marketing hurdles. Leave with proven strategies and
                    innovative ideas to elevate success.
                  </p>
                </div>
              </div>
            </div>
