            ...
            <div className="col-lg-6">
              <div className="about6-header heading9">
                ...
                <p data-aos="fade-left" data-aos-duration={900}>
                  The Marketing Summit 2024 is more than just a conference—it's an opportunity to redefine your marketing approach. From seasoned professionals
                  to emerging talents, this summit is designed for those who are passionate about staying ahead of the curve.
                </p>
                <div className="space16" />
                <p data-aos="fade-left" data-aos-duration={1000}>
                  With a focus on digital transformation, content strategies, and data-driven decision-making, attendees will walk away with actionable insights
                  to drive their brand's success."
                </p>
                <div className="space32" />
                <div className="btn-area1" data-aos="fade-left" data-aos-duration={1200}>
                  <Link href="/about" className="vl-btn6">
                    About Event <img src="/assets/img/icons/arrow2.svg" alt="" />
                  </Link>
                </div>
              </div>
            </div>
