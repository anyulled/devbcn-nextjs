            ...
            <div className="col-lg-12">
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-5">
                    <div className="content-area">
                      <h3 className="text-anime-style-3">“The Marketing Summit 2025 will be hosted at the iconic Grand Convention Center.”</h3>
              ...
              <div className="event6-widget-boxarea2" data-aos="fade-right" data-aos-duration={1100}>
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-5">
                    <div className="content-area">
                      <h3 className="text-anime-style-3">“The Global Marketing Summit will be hosted at the iconic Riverfront Convention Center.”</h3>
                      <div className="space24" />
                      <ul>
                        <li>
                          <Link href="/#">
