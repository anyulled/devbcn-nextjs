          ...
          <div className="col-lg-6">
            <div className="about-imges">
              ...
              <div className="about-btnarea">
                ...
                <Link href="/pricing-plan" onClick={() => trackTicketClick("hero_section", yearFromPath)}>
                  <span>
          ...
          <div className="col-lg-6">
            <div className="about-header-area heading2">
              ...
              <p data-aos="fade-left" data-aos-duration={900}>
                Reflects Our commitment To Driving Progress Embracing Innovation In An Ever-evolving Marketplace. Our Conference is Designed to be a hub for
                thought leadership, where business pioneers and emerging.
              </p>
              ...
              <div className="about-auhtor-box" data-aos="fade-left" data-aos-duration={1000}>
                ...
                <div className="text">
                  ...
                  <div className="space12" />
                  <p>The title captures our mission to empower businesses to not only adapt but lead in this new era of digital.</p>
                </div>
              </div>
              ...
              <div className="about-auhtor-box" data-aos="fade-left" data-aos-duration={1100}>
                ...
                <div className="text">
                  ...
                  <div className="space12" />
                  <p>By shaping the future today, we aim to create a lasting impact that will resonate across industries and inspire.</p>
                </div>
              </div>
              <div className="space32" />
