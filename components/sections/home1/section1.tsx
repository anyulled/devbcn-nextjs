            ...
            <div className="col-lg-6">
              <div className="hero1-header heading1">
                ...
                <h1 className="text-anime-style-3">
                  Business Forward 2025 Strategies{" "}
                  <br className="d-lg-block d-none" />
                  for a New Era
                </h1>
                <div className="space16" />
                <p data-aos="fade-left" data-aos-duration={900}>
                  Welcome Innovate 2025 Shaping the Future of Business,{" "}
                  <br className="d-lg-block d-none" />
            ...
            <div className="col-lg-5">
              <div className="header-images">
                ...
                >
                  ...
                  <div className="space16" />
                  <p>
                    Join us for an extraordinary two-day journey into the realm
                    of innovation at The Innovation Summit.
                  </p>
                </div>
              </div>
            </div>
