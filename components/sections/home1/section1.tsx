  ...
  return (
    <>
      <div className="hero1-section-area">
        <div className="bg1">
          <Image src="/assets/img/bg/header-bg2.png" alt="" className="header-bg1" fill style={{ objectFit: "cover" }} priority />
        </div>
            ...
            <div className="col-lg-6">
              <div className="hero1-header heading1">
                <h5 data-aos="fade-left" data-aos-duration={800}>
                  <Image src="/assets/img/icons/sub-logo1.svg" alt="" width={20} height={20} />
                ...
                <div className="btn-area1" data-aos="fade-left" data-aos-duration={1100}>
                  <Link href="/event-schedule" className="vl-btn1">
                    Reserve My Seat
                  </Link>
                  <Link href="/about" className="vl-btn2">
                    Learn More
                  </Link>
                </div>
              </div>
            ...
            <div className="col-lg-5">
              <div className="header-images">
                <div className="img1" data-aos="zoom-in" data-aos-duration={1000}>
                  <Image src="/assets/img/all-images/hero/hero-img1.png" alt="" width={500} height={500} style={{ width: "100%", height: "auto" }} priority />
                </div>
                <div className="images-content-area" data-aos="fade-up" data-aos-duration={900}>
                  ...
                  <div className="space16" />
                  <p>Join us for an extraordinary two-day journey into the realm of innovation at The Innovation Summit.</p>
                </div>
              </div>
            </div>
