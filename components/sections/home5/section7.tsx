          ...
          <div className="row">
            <div className="col-lg-11 m-auto">
              <div className="heading8 text-center space-margin80">
                ...
                <h2>
                  How You Can <span>Participate</span>
                </h2>
              </div>
            </div>
          </div>
                    ...
                    >
                      <li className="nav-item" onClick={() => handleTab(1)}>
                        ...
                        >
                          ...
                          <span>
                            It all starts with understanding your unique needs,
                            Our team takes the time to learn about your goal.
                          </span>
                        </a>
                      </li>
