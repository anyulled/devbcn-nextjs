                  ...
                  <div className="col-lg-5">
                    <div className="content-area">
                      <h3 className="text-anime-style-3">
                        “The Future of AI in Everyday Life with Emily Chang, CEO
                        of TechX Solutions.”
                      </h3>
              ...
              >
                <div className="row align-items-center">
                  <div className="col-lg-7">
                    <div className="img1 image-anime reveal">
                      <img
                        src="/assets/img/all-images/event/event-img26.png"
                        alt=""
                      />
                    </div>
                  </div>
                  <div className="col-lg-5">
                    <div className="content-area">
                      <h3 className="text-anime-style-3">
                        “Cybersecurity Trends and Threats" by Rachel Wong,
                        Cybersecurity Expert at SecureNet.”
                      </h3>
                      <div className="space24" />
                      <ul>
                        <li>
