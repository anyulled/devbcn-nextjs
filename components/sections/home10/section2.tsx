            ...
            <div className="col-lg-6">
              <div className="about-header heading13">
                ...
                <p data-aos="fade-left" data-aos-duration={900}>
                  The Technology Forum Conference brings together thought leaders, innovators, and tech enthusiasts to discuss the latest developments in AI,
                  cybersecurity, blockchain, cloud computing, and more. Dive into keynote presentations, hands-on workshops, and interactive panel discussions
                  designed push the boundaries of what’s possible in the tech world.
                </p>
                ...
                <div className="btn-area1" data-aos="fade-left" data-aos-duration={1200}>
                  <Link href="/event-schedule" className="vl-btn10">
