                ...
                <div className="row align-items-center">
                  <div className="col-lg-5">
                    <div className="content-area">
                      <h3 className="text-anime-style-3">
                        “The Technology Forum Summit 2025 will be hosted at the
                        iconic Grand Convention Center.”
                      </h3>
                      <div className="space16" />
                      <p>
                        Hear from top industry experts and get exclusive
                        insights into emerging technologies. Participate in
                        workshops that offer real-world applications of today’s
                        technology. Connect with peers, investors, and tech
                        pioneers to expand your professional network.
                      </p>
                      <div className="space32" />
                      <div className="btn-area1">
                        <Link href="/event" className="vl-btn10">
                          See Eventify{" "}
                  ...
                  <div className="col-lg-6">
                    <div className="img1 image-anime reveal">
                      <img
                        src="/assets/img/all-images/event/event-img25.png"
                        alt=""
                      />
                    </div>
                  </div>
