                ...
                <div className="row align-items-center">
                  <div className="col-lg-5">
                    <div className="content-area">
                      ...
                      <p>
                        Hear from top industry experts and get exclusive insights into emerging technologies. Participate in workshops that offer real-world
                        applications of today’s technology. Connect with peers, investors, and tech pioneers to expand your professional network.
                      </p>
                      <div className="space32" />
                      <div className="btn-area1">
                        <Link href="/event" className="vl-btn10">
                          See Eventify <img src="/assets/img/icons/arrow2.svg" alt="" />
                        </Link>
                      </div>
                    </div>
                  </div>
