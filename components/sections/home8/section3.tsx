                          ...
                          <div className="row align-items-center">
                            <div className="col-lg-7">
                              <div className="content-area">
                                ...
                                <p>
                                  Two days to share knowledge and experiences,
                                  meet enthusiasts and geeks and learn about new
                                  technologies related to Backend and frontend
                                  development, AI, Agile, DevOps, Cloud, and
                                  many others.
                                </p>
                          ...
                          <div className="row align-items-center">
                            <div className="col-lg-7">
                              <div className="content-area">
                                ...
                                <div className="space20" />
                                <p>
                                  This conference is the perfect stage to
                                  discover how others are using your favourite
                                  technology. There is something interesting for
                                  any kind of tech passionate: on the backend
                                  Java & JVM, Python, to Frontend with
                                  JavaScript, TypeScript and Web assembly; Also,
                                  Cloud, Kubernetes, and DevOps, Agile, Big
                          ...
                          <div className="row align-items-center">
                            <div className="col-lg-7">
                              <div className="content-area">
                                ...
                                <div className="space20" />
                                <p>
                                  DevBcn is the rebranding of the biggest Java &
                                  JVM conference in Spain, now including more
                                  technologies and tracks.
                                </p>
                                <div className="space24" />
                                <p>
                                  Check for videos/photos and summary of the
                                  DevBcn — 2025 edition — 2024 edition — 2023
                                  edition
                                </p>
                                <div className="btn-area1">
                                  <a
