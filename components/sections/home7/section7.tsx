            ...
            <div className="col-lg-12 testimonial-content-slider7">
              <Swiper {...swiperOptions} className=" owl-carousel">
                <SwiperSlide className="testimonial-widget-box">
                  ...
                  <p>“Attending Economy Events was a transformative experience that provided invaluable insights into the complexities of today’s global.”</p>
                ...
                <SwiperSlide className="testimonial-widget-box">
                  ...
                  <div className="space22" />
                  <p>“The diverse lineup speakers, from policymakers to industry leaders, offered perspectives on economic trends and practical solutions.”</p>
                  <div className="space24" />
                  <div className="auhtor-area">
                    <div className="name-area">
                      <div className="img1">
                ...
                <SwiperSlide className="testimonial-widget-box">
                  ...
                  <div className="space22" />
                  <p>
                    “The sessions were both thought-provoking &amp; actionable, equipping with strategies to navigate market uncertainties new opportunities.”
                  </p>
                  <div className="space24" />
                  <div className="auhtor-area">
                    <div className="name-area">
