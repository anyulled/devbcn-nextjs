            ...
            <div className="col-lg-6">
              <div className="about-header-area heading10">
                <h2 className="text-anime-style-3">
                  Transforming the of Global Economic Landscape
                </h2>
                <div className="space16" />
                <p data-aos="fade-left" data-aos-duration={900}>
                  Our mission at Economy Event to drive meaningful dialogue,
                  foster collaboration, spark innovative solutions for
                ...
                >
                  ...
                  <div className="text">
                    ...
                    <p>
                      This event brings together economists business leaders
                      policymakers, and innovators from around the globe.
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="text">
                    ...
                    <div className="space12" />
                    <p>
                      With a focus on topics such as global trade, financial
                      technology, sustainable development, and policy.
                    </p>
                  </div>
                </div>
                <div className="space32" />
            ...
            <div className="col-lg-6">
              <div className="about-all-images">
                ...
                <div className="img2 image-anime reveal">
                  <img
                    src="/assets/img/all-images/about/about-img18.png"
                    alt=""
                  />
                </div>
                ...
                <img
                  src="/assets/img/elements/elements37.png"
                  alt=""
