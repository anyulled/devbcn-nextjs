            ...
            <div className="col-lg-5">
              <div className="about2-header heading4">
                ...
                <p data-aos="fade-left" data-aos-duration={900}>
                  At Business, we bring together brightest minds, leaders, and trailblazers from across industries to explore latest trends, technologies, and
                ...
                <div className="others-boxarea" data-aos="fade-left" data-aos-duration={1000}>
                  <div className="icons-box">
                    ...
                    <p>
                      <CountUp className="odometer" enableScrollSpy={true} end={40} />+ Speakers
                    </p>
                  </div>
                  <div className="icons-box">
                    <div className="icons">
                    ...
                    <p>
                      <CountUp className="odometer" enableScrollSpy={true} end={19} />+ Sponsors
                    </p>
                  </div>
                </div>
                ...
                <div className="btn-area1" data-aos="fade-left" data-aos-duration={1200}>
                  <Link href="/contact" className="vl-btn2">
                    <span className="demo">Become an Attendee</span>
