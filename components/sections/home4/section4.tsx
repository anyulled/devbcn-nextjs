        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-5">
              <div
                className="event-images-area"
                data-aos="zoom-in"
                data-aos-duration={1000}
              >
                <div className="img1">
                  <img
                    src="/assets/img/all-images/event/event-img7.png"
                    alt=""
                  />
                </div>
              ...
              <div data-aos="fade-up" data-aos-duration={900}>
                ...
                >
                  ...
                  <li className="nav-item" onClick={() => handleTab(4)}>
                    ...
                    <button
                      className={
                        isTab == 4 ? "nav-link m-0 active" : "nav-link m-0"
                      }
                    ...
                    <div className="accordion-item">
                      ...
                      >
                        <div className="accordion-body">
                          <p>
                            Kick off the day with coffee and conversations. Meet
                            fellow innovators &amp; industry leaders.
                          </p>
                        </div>
                      </div>
                    </div>
