        ...
        <div className="feature-content-wrapper">
          ...
          <div className="feature-info">
            ...
            <div className="feature-description">
              <p>
                Our Speaking Mentoring sessions are dedicated to helping developers become better communicators. Whether you're a first-time speaker or looking
                to refine your stage presence, these 1-hour sessions provide personalized feedback and strategies.
              </p>
              <p>
