...
import Section3TabPane from "./Section3TabPane";
          ...
          <div className="row">
            <div className="col-lg-12" data-aos="fade-up" data-aos-duration={1000}>
              ...
              <div className="tab-content" id="pills-tabContent">
                <Section3TabPane isActive={isTab == 1} id="pills-home" labelledBy="pills-home-tab" />
                <Section3TabPane isActive={isTab == 2} id="pills-profile" labelledBy="pills-profile-tab" />
                <Section3TabPane isActive={isTab == 3} id="pills-contact" labelledBy="pills-contact-tab" />
              </div>
            </div>
          </div>
        </div>
