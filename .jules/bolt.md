...
**Action:** Extract derived values from the final *filtered* array instead of relying on side effects during iteration, particularly when enforcing strict no-mutation boundaries in performance improvements.
