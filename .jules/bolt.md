...
## 2026-08-26 - Avoid .filter().slice() for array extraction with limit

**Learning:** Using `.filter().slice(0, limit)` creates a full array traversal and allocates a discarded intermediate array.
