...
/**
 * Job Offers Data for 2025 Edition
 *
 * All job descriptions have been converted from HTML to Markdown format.
 */

export const jobOffers2025: Company[] = [
  {
    name: "Caixabank Tech",
    ...
    offers: [
      {
        ...
        location: "Hybrid",
        text: `Programación y desarrollo de productos, proyectos y soluciones en el sector financiero
...
Desarrollo integral de software comprendiendo todo el ciclo de vida: revisión de requerimientos, análisis de la solución, programación y pruebas, revisión del incidental y evolución`,
  ...
  },
  {
    ...
    logo: "/assets/img/all-images/sponsors/logo-snowflake.png",
    ...
    offers: [
      ...
      },
      {
        ...
        text: `As a Production Software Engineer at Snowflake, you will:
...
- Plan and lead complex technical projects while partnering with a wide variety of teams within the company`,
  ...
  {
    name: "Manychat",
    id: "e7bd4ce1-ca17-400f-89de-ebb4a98a5b4d",
    description:
      "Manychat is a leading Chat Marketing platform. As an official Meta Business Partner, we help businesses engage with their customers on Instagram, TikTok, Facebook Messenger, WhatsApp, and Telegram.",
    logo: "/assets/img/all-images/sponsors/logo-manychat.webp",
    url: "https://careers.manychat.com",
    linkedin: "https://www.linkedin.com/company/manychat",
    twitter: "https://x.com/manychathq",
    offers: [
      {
        id: "7359fdee-d287-4d45-89f5-b251d07f3e83",
        title: "Senior Backend Engineer (Mobile Team)",
        location: "Hybrid",
        url: "https://grnh.se/883ec4c92us",
        text: `We are seeking a Senior PHP Developer who's all about building smart tech and even better experiences for users. Our cross-functional mobile teams cover a wide range of tasks, allowing engineers to work on various product components. We believe that mobile is key to our platform's future, and you'll play a key role in shaping that future.

Here, product development goes beyond coding — it's about creating meaningful value. We're looking for someone who sees technology as a way to deliver business wins and takes technical quality seriously.

You'll join an engineering culture, where ownership is real: teams decide how they build and deliver, always with company goals in mind. Plus, you'll connect with our internal tech groups, helping raise the bar even higher.`,
      },
      {
  ...
  },
  {
    ...
    logo: "/assets/img/all-images/sponsors/vonage.jpg",
...
We are looking for Full-Stack Web Developers (frontend focus), Frontend Native SDET, and Java Software Engineers to join our team. You'll enhance the developer experience and improve the capabilities of our video APIs, help drive innovation, and contribute across the Vonage Video Platform.`,
  ...
  {
    name: "Dynatrace",
    id: "a8e9f5c6-d7b4-4a3e-9c2d-1f0e8b7a6c5d",
    description:
    ...
    logo: "/assets/img/all-images/sponsors/dynatrace.png",
    ...
    offers: [
      {
        ...
        text: `**Your role at Dynatrace**

React | Data Visualization | Distributed Systems | Open Source | Observability | APM
...
Do you thrive for improving the quality bar of the teams you work with?

Are you a proactive team-player willing to join an outstanding work environment?
...
Dynatrace, the world's number one Software Intelligence monitoring platform, provides answers, not just data, about application performance and end-user experience. We're looking for talented Software Engineers to make our product even better.

**Your role:**

- You'll develop services in Java/Spring Boot for collecting data signals from multiple Cloud Providers.
- You'll work with the most popular Cloud Providers
- You will be a part of the whole implementation process, starting with talks with Product Managers and Architects through design, coding, and release preparation,
- You will have one day per sprint devoted just to self-development and mentoring from best-in-class software engineers,
- You will be working with highly skilled engineers who prioritize teamwork, using collaborative practices such as pair programming to build software end-to-end, including debugging, testing, and fixing.`,
      },
      {
...
The Business Analytics team enhances the Dynatrace platform with a suite of applications designed to provide our customers with actionable business insights. Our mission is to leverage data to measure the impact of IT service quality on business process KPIs. Our team is currently focused on developing four innovative applications.

Our distributed Scrum teams build those applications using TypeScript and React and complement them with serverless functions in Typescript and Spring Boot applications. We turn large amounts of data into visualizations that deliver relevant business insights.
